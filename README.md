# Music Booking App with AI- Adesoji

Upload a book and it's converted to mp3
...
```bash
git clone https://github.com/your-username/ Music Booking App -backend-assessment-Adesoji.git
cd  Music Booking App -backend-assessment-Adesoji
```

2. Set up a virtual environment and activate it:

```bash
python3 -m venv  Music Booking App env
source  Music Booking App env/bin/activate
```
